...
class AsyncSalesforceClient(AsyncClient, TokenRefreshCallbackMixin):
    ...
    async def __aenter__(self):
        ...
        LOGGER.info("Logged into %s as %s (%s)", self.base_url, userinfo["name"], userinfo["preferred_username"])
        return self
    ...
    async def request(self, method: str, url: URL | str, resource_name: str = "", **kwargs) -> Response:
...
class SalesforceClient(Client, TokenRefreshCallbackMixin):
    ...
    def request(self, method: str, url: URL | str, resource_name: str = "", **kwargs) -> Response:
