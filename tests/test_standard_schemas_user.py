...
def test_user_password_expired(mocker):
    ...
    mock_client.sobjects_url = "https://example.salesforce.com/services/data/v50.0/sobjects"
...
def test_password_operations_with_connection_string(mocker):
    ...
    mocker.patch('sf_toolkit.data.standard_schemas.SalesforceClient.get_connection',
...
def test_password_operations_without_id():
    ...
    with pytest.raises(AssertionError, match="User Id must be set to check password expiration"):
